...
Этот проект лицензируется по **CC BY-NC-SA 4.0** (Non-Commercial).

- ✅ Разрешено: обучение, портфолио, демонстрация на собеседованиях
- ❌ Запрещено: коммерческое использование без письменного разрешения

Для коммерческой лицензии: sh_dmitrii@inbox.ru